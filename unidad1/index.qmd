...
En la plataforma moodle tienen el programa con la información administrativa del curso. 
:::
...
- Las columnas pueden ser de diferentes tipos, pero todas las filas de cada columna deben tener un mismo tipo de dato.
