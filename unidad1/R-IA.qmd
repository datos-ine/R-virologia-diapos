---
pagetitle: "Uso responsable de la IA"
subtitle: "Unidad 1"
format: 
  revealjs:
    auto-stretch: false
...
## {#intro-curso data-menu-title="IA generativa como asistente de análisis de datos en R" .invert}

[**IA generativa como asistente de análisis de datos en R**]{.custom-title} 


## IA generativa {.title-top}
...
- **Principio**: Dependiendo de la situación podemos usar lenguaje natural o algun formato estructurado (por ejemplo: json, xml, etc). 

  - Lenguaje natural para la exploración inicial o resolución de errores.

  - Lenguaje estructurado para producción de scrips o tareas complejas.

- **Beneficio**: Reduce errores de interpretación y ambiguedad, en tanto posibilita manejo de múltiples restricciones.
...
Ejemplo de prompt en lenguaje JSON

```{r, echo=TRUE, eval=FALSE}
{
  "tarea": "transformacion_datos",
  "paquete_preferido": "tidyverse",
  "input": "data_frame_salud",
  "operaciones": ["group_by(provincia)", "summarise(total = sum(casos))"],
  "retornar_solo_codigo": true
}
```
