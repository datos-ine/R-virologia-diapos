...
- Está definida por dos parámetros: la media (determina la ubicación del centro de la distribución) y la varianza o desvió estándar (determina qué tan "ancha" o "delgada" es la campana.
...
- Es el "puente" que justifica el uso de tests paramétricos (como el t-test o ANOVA) y el cálculo de intervalos de confianza en muestras que no siguen exactamente una campana de Gauss (en n grandes y con distribuciones no sesgadas)
...
| ANOVA                                  | Comparar medias entre tres o más grupos independientes.         |
| ANOVA de medidas repetidas             | Comparar medias en tres o más mediciones de los mismos sujetos. |
...
| Kruskal-Wallis       | ANOVA                      | Comparar tres o más grupos independientes.   |
| Friedman             | ANOVA de medidas repetidas | Comparar tres o más mediciones relacionadas. |
