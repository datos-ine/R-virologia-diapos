...
2.  **Pruebas de hipótesis**: Evaluar afirmaciones sobre uno o más parámetros basándose en evidencia estadística.
...
Aunque no es compatible de forma directa con *tidyverse*, el paquete `DescTools` facilita estos cálculos.
