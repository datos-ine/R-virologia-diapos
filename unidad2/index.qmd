...
Si definimos variables, busca los duplicados en esas combinaciones (útil cuando tenemos una o más variables claves, claves primarias o identificadores que deberían ser únicos -claves compuestas-)
...
Para esta tarea, tenemos que decidir en que formato los guardamos. Se aconseja hacerlo un formato `csv` (texto plano separado por comas), dado que es universal; pero se puede seleccionar otro formato.
